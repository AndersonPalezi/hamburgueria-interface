    ...
    <Container>
      <Img__Container>
        <figure>
          ...
          <figcaption><H1>CodeByte Burger Bar</H1>
      ...
      <Login__Container>
        ...
        <P >Somos uma <span>hamburgueria</span> temática voltada<br></br> para amantes
        ...
        <Form>
          ...
          <H3>Esqueçi minha <a>senha.</a></H3>
          <Button__logar>Logar</Button__logar>
        </Form>
        <H3>Não possui conta? <a>Clique aqui</a></H3>
      </Login__Container>
    </Container>
  );
}
